# =========================================
# 🌌 Spectra6 All-in-One Windows Setup
...
function Show-CyberpunkDashboard {
    ...
    Write-Host "$Cyan┌─────────────── Spectra6 All-in-One ────────────────┐$Reset"
...
Show-CyberpunkDashboard ".\spectra6_windows_all_in_one.ps1"
...
$LogFile = Join-Path $BaseDir ("spectra6_all_in_one_$(Get-Date -Format 'yyyyMMdd_HHmmss').log")
...
# -----------------------------
Log "💛 PostgreSQL setup placeholder (configure user/db/pgvector manually)" "Yellow"
...
# Completion
# -----------------------------
Log "💚 All-in-One setup complete!" "Green"
Write-Host "$Magenta🎉 Enjoy your Spectra6 cyberpunk environment!$Reset"